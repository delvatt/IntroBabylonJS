...
! function(a) {
	...
	var f = function() {
		function a(a, b, c, d) {
			"undefined" == typeof a && (a = 0), "undefined" == typeof b && (b = 0), "undefined" == typeof c && (c = 0), "undefined" == typeof d && (d = 0), this.x = a, this.y = b, this.z = c, this.w = d
		}
		return a.prototype.toString = function() {
			...
			var a = this.x,
				...
				g = b * b,
				h = c * c,
				i = Math.atan2(2 * (b * d - a * c), 1 - 2 * (g + h)),
				j = Math.asin(2 * (a * b + c * d)),
				k = Math.atan2(2 * (a * d - b * c), 1 - 2 * (f + h)),
				l = a * b + c * d;
			return l > .499 ? (i = 2 * Math.atan2(a, d), k = 0) : -.499 > l && (i = -2 * Math.atan2(a, d), k = 0), new e(j, i, k)
	...
	var b, c = 60,
		...
		h = function() {
			...
			return h.GetFilename = function(a) {
				...
				return f
			}, h.LoadFile = function(b, c, d, e, f) {
				b = h.CleanUrl(b);
				var g = function() {
						var e = new XMLHttpRequest,
							g = h.BaseUrl + b;
						e.open("GET", g, !0), f && (e.responseType = "arraybuffer"), e.onprogress = d, e.onreadystatechange = function() {
							if (4 == e.readyState) {
								if (200 != e.status && !a.Tools.ValidateXHRData(e, f ? 6 : 1)) throw new Error("Error status: " + e.status + " - Unable to load " + g);
								c(f ? e.response : e.responseText)
							}
						}, e.send(null)
					},
					i = function() {
						e.loadFileFromDB(b, c, d, g, f)
					};
				if (-1 !== b.indexOf("file:")) {
					var j = b.substring(5);
					a.Tools.ReadFile(a.FilesInput.FilesToLoad[j], c, d, !0)
				} else e && e.enableSceneOffline ? e.openAsync(i, g) : g()
				...
				enumerable: !0,
				configurable: !0
			}), h.BaseUrl = "", h._NoneLogLevel = 0, h._MessageLogLevel = 1, h._WarningLogLevel = 2, h._ErrorLogLevel = 4, h.Log = h._LogEnabled, h.Warn = h._WarnEnabled, h.Error = h._ErrorEnabled, h
		}();
	a.Tools = h
}(BABYLON || (BABYLON = {}));
var BABYLON;
! function(a) {
	var b = function(a, b, c, d) {
		...
		e = function(b, e, f, g, h, i, j, k, l, m) {
			"undefined" == typeof m && (m = a.Texture.TRILINEAR_SAMPLINGMODE);
			var n = f.getEngine(),
				o = d(g, n.getCaps().maxTextureSize),
				p = d(h, n.getCaps().maxTextureSize);
			e.bindTexture(e.TEXTURE_2D, b), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, void 0 === i ? 1 : i ? 1 : 0), l(o, p);
			var q = c(m, !j, e);
			e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, q.mag), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, q.min), j || k || e.generateMipmap(e.TEXTURE_2D), e.bindTexture(e.TEXTURE_2D, null), n._activeTexturesCache = [], b._baseWidth = g, b._baseHeight = h, b._width = o, b._height = p, b.isReady = !0, f._removePendingData(b)
		},
		f = function(b, c, d, e, g, h) {
			var i, j = function() {
					d.push(i), e._removePendingData(i), c != h.length - 1 ? f(b, c + 1, d, e, g, h) : g(d)
				},
				k = function() {
	...
	var h = function() {
		function h(a, b, c) {
			...
			try {
				this._gl = a.getContext("webgl", c) || a.getContext("experimental-webgl", c)
			} catch (e) {
				throw new Error("WebGL not supported")
			}
			if (!this._gl) throw new Error("WebGL not supported");
			this._onBlur = function() {
				d._windowIsBackground = !0
			}, this._onFocus = function() {
				d._windowIsBackground = !1
				...
				void 0 !== document.fullscreen ? d.isFullscreen = document.fullscreen : void 0 !== document.mozFullScreen ? d.isFullscreen = document.mozFullScreen : void 0 !== document.webkitIsFullScreen ? d.isFullscreen = document.webkitIsFullScreen : void 0 !== document.msIsFullScreen && (d.isFullscreen = document.msIsFullScreen), d.isFullscreen && d._pointerLockRequested && (a.requestPointerLock = a.requestPointerLock || a.msRequestPointerLock || a.mozRequestPointerLock || a.webkitRequestPointerLock, a.requestPointerLock && a.requestPointerLock())
			}, document.addEventListener("fullscreenchange", this._onFullscreenChange, !1), document.addEventListener("mozfullscreenchange", this._onFullscreenChange, !1), document.addEventListener("webkitfullscreenchange", this._onFullscreenChange, !1), document.addEventListener("msfullscreenchange", this._onFullscreenChange, !1), this._onPointerLockChange = function() {
				d.isPointerLock = document.mozPointerLockElement === a || document.webkitPointerLockElement === a || document.msPointerLockElement === a || document.pointerLockElement === a
		...
		return Object.defineProperty(h, "ALPHA_DISABLE", {
		...
		}, h.prototype.stopRenderLoop = function() {
			...
			this._gl.clearColor(a.r, a.g, a.b, void 0 !== a.a ? a.a : 1), this._depthMask && this._gl.clearDepth(1);
			var d = 0;
			b && (d |= this._gl.COLOR_BUFFER_BIT), c && this._depthMask && (d |= this._gl.DEPTH_BUFFER_BIT), this._gl.clear(d)
		...
		}, h.prototype.updateDynamicVertexBuffer = function(a, b) {
			...
			return d ? void this._caps.instancedArrays.drawElementsInstancedANGLE(a ? this._gl.TRIANGLES : this._gl.LINES, c, this._gl.UNSIGNED_SHORT, 2 * b, d) : void this._gl.drawElements(a ? this._gl.TRIANGLES : this._gl.LINES, c, this._gl.UNSIGNED_SHORT, 2 * b)
		...
		}, h.prototype.createShaderProgram = function(a, c, d) {
			var e = b(this._gl, a, "vertex", d),
				f = b(this._gl, c, "fragment", d),
			...
			this._cullingState !== a && (a ? (this._gl.cullFace(this.cullBackFaces ? this._gl.BACK : this._gl.FRONT), this._gl.enable(this._gl.CULL_FACE)) : this._gl.disable(this._gl.CULL_FACE), this._cullingState = a)
		}, h.prototype.setDepthBuffer = function(a) {
			a ? this._gl.enable(this._gl.DEPTH_TEST) : this._gl.disable(this._gl.DEPTH_TEST)
		}, h.prototype.setDepthWrite = function(a) {
			this._gl.depthMask(a), this._depthMask = a
		}, h.prototype.setColorWrite = function(a) {
			this._gl.colorMask(a, a, a, a)
		}, h.prototype.setAlphaMode = function(b) {
			switch (b) {
		...
		}, h.prototype.createTexture = function(b, c, d, f, g) {
			var h = this;
			"undefined" == typeof g && (g = a.Texture.TRILINEAR_SAMPLINGMODE);
			var i = this._gl.createTexture(),
				j = b.substr(b.length - 4, 4).toLowerCase(),
				k = this.getCaps().s3tc && ".dds" === j,
				l = ".tga" === j;
			if (f._addPendingData(i), i.url = b, i.noMipmap = c, i.references = 1, this._loadedTexturesCache.push(i), l) a.Tools.LoadFile(b, function(b) {
				var j = new Uint8Array(b),
					k = a.Internals.TGATools.GetTGAHeader(j);
				e(i, h._gl, f, k.width, k.height, d, c, !1, function() {
					a.Internals.TGATools.UploadContent(h._gl, j)
				}, g)
			}, null, f.database, !0);
			else if (k) a.Tools.LoadFile(b, function(j) {
				var k = a.Internals.DDSTools.GetDDSInfo(j),
					l = (k.isRGB || k.isLuminance || k.mipmapCount > 1) && !c && k.width >> k.mipmapCount - 1 == 1;
				e(i, h._gl, f, k.width, k.height, d, !l, k.isFourCC, function() {
					console.log("loading " + b), a.Internals.DDSTools.UploadDDSLevels(h._gl, h.getCaps().s3tc, j, k, l, 1)
				}, g)
			}, null, f.database, !0);
			else {
				var m = function(a) {
						e(i, h._gl, f, a.width, a.height, d, c, !1, function(b, c) {
							var d = a.width == b && a.height == c;
							d || (h._workingCanvas.width = b, h._workingCanvas.height = c, h._workingContext.drawImage(a, 0, 0, a.width, a.height, 0, 0, b, c)), h._gl.texImage2D(h._gl.TEXTURE_2D, 0, h._gl.RGBA, h._gl.RGBA, h._gl.UNSIGNED_BYTE, d ? a : h._workingCanvas)
						}, g)
					},
					n = function() {
						f._removePendingData(i)
					};
				a.Tools.LoadImage(b, m, n, f.database)
			}
			return i
		}, h.prototype.createDynamicTexture = function(a, b, e, f) {
			var g = this._gl.createTexture();
			a = d(a, this._caps.maxTextureSize), b = d(b, this._caps.maxTextureSize), this._gl.bindTexture(this._gl.TEXTURE_2D, g);
			var h = c(f, e, this._gl);
			return this._gl.texParameteri(this._gl.TEXTURE_2D, this._gl.TEXTURE_MAG_FILTER, h.mag), this._gl.texParameteri(this._gl.TEXTURE_2D, this._gl.TEXTURE_MIN_FILTER, h.min), this._gl.bindTexture(this._gl.TEXTURE_2D, null), this._activeTexturesCache = [], g._baseWidth = a, g._baseHeight = b, g._width = a, g._height = b, g.isReady = !1, g.generateMipMaps = e, g.references = 1, this._loadedTexturesCache.push(g), g
		...
		}, h.prototype.createRenderTargetTexture = function(b, d) {
			var e = !1,
				f = !0,
				g = a.Texture.TRILINEAR_SAMPLINGMODE;
			void 0 !== d && (e = void 0 === d.generateMipMaps ? d : d.generateMipmaps, f = void 0 === d.generateDepthBuffer ? !0 : d.generateDepthBuffer, void 0 !== d.samplingMode && (g = d.samplingMode));
			var h = this._gl,
				i = h.createTexture();
			...
			return h.bindFramebuffer(h.FRAMEBUFFER, n), h.framebufferTexture2D(h.FRAMEBUFFER, h.COLOR_ATTACHMENT0, h.TEXTURE_2D, i, 0), f && h.framebufferRenderbuffer(h.FRAMEBUFFER, h.DEPTH_ATTACHMENT, h.RENDERBUFFER, m), h.bindTexture(h.TEXTURE_2D, null), h.bindRenderbuffer(h.RENDERBUFFER, null), h.bindFramebuffer(h.FRAMEBUFFER, null), i._framebuffer = n, f && (i._depthBuffer = m), i._width = j, i._height = k, i.isReady = !0, i.generateMipMaps = e, i.references = 1, this._activeTexturesCache = [], this._loadedTexturesCache.push(i), i
		}, h.prototype.createCubeTexture = function(b, c, e, g) {
			var h = this,
				i = this._gl,
				j = i.createTexture();
			j.isCube = !0, j.url = b, j.references = 1, this._loadedTexturesCache.push(j);
			var k = b.substr(b.length - 4, 4).toLowerCase(),
				l = this.getCaps().s3tc && ".dds" === k;
			return l ? a.Tools.LoadFile(b, function(b) {
				var c = a.Internals.DDSTools.GetDDSInfo(b),
					d = (c.isRGB || c.isLuminance || c.mipmapCount > 1) && !g;
				i.bindTexture(i.TEXTURE_CUBE_MAP, j), i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, 1), a.Internals.DDSTools.UploadDDSLevels(h._gl, h.getCaps().s3tc, b, c, d, 6), g || c.isFourCC || 1 != c.mipmapCount || i.generateMipmap(i.TEXTURE_CUBE_MAP), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_MIN_FILTER, d ? i.LINEAR_MIPMAP_LINEAR : i.LINEAR), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), i.bindTexture(i.TEXTURE_CUBE_MAP, null), h._activeTexturesCache = [], j._width = c.width, j._height = c.height, j.isReady = !0
			}) : f(b, 0, [], c, function(a) {
				var b = d(a[0].width, h._caps.maxCubemapTextureSize),
					c = b;
				h._workingCanvas.width = b, h._workingCanvas.height = c;
				var e = [i.TEXTURE_CUBE_MAP_POSITIVE_X, i.TEXTURE_CUBE_MAP_POSITIVE_Y, i.TEXTURE_CUBE_MAP_POSITIVE_Z, i.TEXTURE_CUBE_MAP_NEGATIVE_X, i.TEXTURE_CUBE_MAP_NEGATIVE_Y, i.TEXTURE_CUBE_MAP_NEGATIVE_Z];
				i.bindTexture(i.TEXTURE_CUBE_MAP, j), i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, 0);
				for (var f = 0; f < e.length; f++) h._workingContext.drawImage(a[f], 0, 0, a[f].width, a[f].height, 0, 0, b, c), i.texImage2D(e[f], 0, i.RGBA, i.RGBA, i.UNSIGNED_BYTE, h._workingCanvas);
				g || i.generateMipmap(i.TEXTURE_CUBE_MAP), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_MIN_FILTER, g ? i.LINEAR : i.LINEAR_MIPMAP_LINEAR), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(i.TEXTURE_CUBE_MAP, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), i.bindTexture(i.TEXTURE_CUBE_MAP, null), h._activeTexturesCache = [], j._width = b, j._height = c, j.isReady = !0
			}, e), j
			...
			for (this.stopRenderLoop(); this.scenes.length;) this.scenes[0].dispose();
		...
		}, h._ALPHA_DISABLE = 0, h._ALPHA_ADD = 1, h._ALPHA_COMBINE = 2, h._DELAYLOADSTATE_NONE = 0, h._DELAYLOADSTATE_LOADED = 1, h._DELAYLOADSTATE_LOADING = 2, h._DELAYLOADSTATE_NOTLOADED = 4, h.Epsilon = .001, h.CollisionsEpsilon = .001, h.ShadersRepository = "Babylon/Shaders/", h
	}();
	a.Engine = h
}(BABYLON || (BABYLON = {}));
var BABYLON;
...
! function(a) {
	var b = function(b, c) {
			var d = a.Vector3.Dot(c.center, b),
				e = Math.abs(a.Vector3.Dot(c.directions[0], b)) * c.extends.x,
				f = Math.abs(a.Vector3.Dot(c.directions[1], b)) * c.extends.y,
				g = Math.abs(a.Vector3.Dot(c.directions[2], b)) * c.extends.z,
				h = e + f + g;
			return {
				min: d - h,
				max: d + h
...
! function(a) {
	var b = function(b) {
		function c(c, d) {
			b.call(this, c, d), this.diffuse = new a.Color3(1, 1, 1), this.specular = new a.Color3(1, 1, 1), this.intensity = 1, this.range = Number.MAX_VALUE, this.excludedMeshes = new Array, this._excludedMeshesIds = new Array, d.lights.push(this)
		}
	...
	var b = function() {
		function b(c, d) {
			...
			var f = function(b) {
				...
				if (!g.mustReturn) {
					var h = null !== f.getCaps().instancedArrays && null !== g.visibleInstances;
					if (e.isReady(b, h)) {
		...
		return Object.defineProperty(b, "FILTER_NONE", {
			...
			a >= 1 ? this._darkness = 1 : 0 >= a && (this._darkness = 0), elsethis._darkness = a
...
! function(a) {
	var b = function(b) {
		function c(c, d, e) {
			b.call(this, c, d, e), this.cameraDirection = new a.Vector3(0, 0, 0), this.cameraRotation = new a.Vector2(0, 0), this.rotation = new a.Vector3(0, 0, 0), this.ellipsoid = new a.Vector3(.5, 1, .5), this.keysUp = [38], this.keysDown = [40], this.keysLeft = [37], this.keysRight = [39], this.speed = 2, this.checkCollisions = !1, this.applyGravity = !1, this.noRotationConstraint = !1, this.angularSensibility = 2e3, this.lockedTarget = null, this._keys = [], this._collider = new a.Collider, this._needMoveForGravity = !0, this._currentTarget = a.Vector3.Zero(), this._viewMatrix = a.Matrix.Zero(), this._camMatrix = a.Matrix.Zero(), this._cameraTransformMatrix = a.Matrix.Zero(), this._cameraRotationMatrix = a.Matrix.Zero(), this._referencePoint = new a.Vector3(0, 0, 1), this._transformedReferencePoint = a.Vector3.Zero(), this._oldPosition = a.Vector3.Zero(), this._diffPosition = a.Vector3.Zero(), this._newPosition = a.Vector3.Zero(), this._lookAtTemp = a.Matrix.Zero(), this._tempMatrix = a.Matrix.Zero()
		}
		return __extends(c, b), c.prototype._getLockedTargetPosition = function() {
		...
		}, c.prototype.attachControl = function(b, c) {
			var d, e = this,
				f = this.getEngine();
			...
			this._checkInputs();
			var b = this._needMoveForGravity || Math.abs(this.cameraDirection.x) > 0 || Math.abs(this.cameraDirection.y) > 0 || Math.abs(this.cameraDirection.z) > 0,
			...
			if (b)
				if (this.checkCollisions && this.getScene().collisionsEnabled) {
					if (this._collideWithWorld(this.cameraDirection), this.applyGravity) {
						var d = this.position;
						this._collideWithWorld(this.getScene().gravity), this._needMoveForGravity = 0 != a.Vector3.DistanceSquared(d, this.position)
					}
				} else this.position.addInPlace(this.cameraDirection);
			if (c && (this.rotation.x += this.cameraRotation.x, this.rotation.y += this.cameraRotation.y, !this.noRotationConstraint)) {
				var e = Math.PI / 2 * .95;
				this.rotation.x > e && (this.rotation.x = e), this.rotation.x < -e && (this.rotation.x = -e)
			}
				...
				if (!this._attachedElement) {
					...
					void 0 === this._onPointerDown && (this._onPointerDown = function(a) {
						...
						if (e && f === a.pointerId) {
							var b = a.clientX - e.x,
								c = a.clientY - e.y;
							g.inertialAlphaOffset -= b / g.angularSensibility, g.inertialBetaOffset -= c / g.angularSensibility, e = {
								x: a.clientX,
								y: a.clientY
							}, d || a.preventDefault()
						}
						...
						if (h.isPointerLock) {
							...
							g.inertialAlphaOffset -= b / g.angularSensibility, g.inertialBetaOffset -= c / g.angularSensibility, d || a.preventDefault()
						}
					}, this._wheel = function(a) {
						var b = 0;
						a.wheelDelta ? b = a.wheelDelta / (40 * g.wheelPrecision) : a.detail && (b = -a.detail / g.wheelPrecision), b && (g.inertialRadiusOffset += b), a.preventDefault && (d || a.preventDefault())
					}, this._onKeyDown = function(a) {
						if (-1 !== g.keysUp.indexOf(a.keyCode) || -1 !== g.keysDown.indexOf(a.keyCode) || -1 !== g.keysLeft.indexOf(a.keyCode) || -1 !== g.keysRight.indexOf(a.keyCode)) {
							var b = g._keys.indexOf(a.keyCode); - 1 === b && g._keys.push(a.keyCode), a.preventDefault && (d || a.preventDefault())
						}
					}, this._onKeyUp = function(a) {
						if (-1 !== g.keysUp.indexOf(a.keyCode) || -1 !== g.keysDown.indexOf(a.keyCode) || -1 !== g.keysLeft.indexOf(a.keyCode) || -1 !== g.keysRight.indexOf(a.keyCode)) {
							var b = g._keys.indexOf(a.keyCode);
							b >= 0 && g._keys.splice(b, 1), a.preventDefault && (d || a.preventDefault())
						}
					}, this._onLostFocus = function() {
						g._keys = [], f = null
					}, this._onGestureStart = function(a) {
						void 0 !== window.MSGesture && (g._MSGestureHandler || (g._MSGestureHandler = new MSGesture, g._MSGestureHandler.target = c), g._MSGestureHandler.addPointer(a.pointerId))
					}, this._onGesture = function(a) {
						g.radius *= a.scale, a.preventDefault && (d || (a.stopPropagation(), a.preventDefault()))
					}, this._reset = function() {
						g._keys = [], g.inertialAlphaOffset = 0, g.inertialBetaOffset = 0, g.inertialRadiusOffset = 0, e = null, f = null
					}), c.addEventListener(b + "down", this._onPointerDown, !1), c.addEventListener(b + "up", this._onPointerUp, !1), c.addEventListener(b + "out", this._onPointerUp, !1), c.addEventListener(b + "move", this._onPointerMove, !1), c.addEventListener("mousemove", this._onMouseMove, !1), c.addEventListener("MSPointerDown", this._onGestureStart, !1), c.addEventListener("MSGestureChange", this._onGesture, !1), c.addEventListener("mousewheel", this._wheel, !1), c.addEventListener("DOMMouseScroll", this._wheel, !1), a.Tools.RegisterTopRootEvents([{
						name: "keydown",
						handler: this._onKeyDown
					}, {
						name: "keyup",
	...
	var b = function() {
		...
		return Object.defineProperty(b.prototype, "meshUnderPointer", {
			...
			this._onPointerMove = function(a) {
				...
				d.hit ? (b.setPointerOverMesh(d.pickedMesh), c.style.cursor = "pointer", b._meshUnderPointer = d.pickedMesh) : (b.setPointerOverMesh(null), c.style.cursor = "", b._meshUnderPointer = null)
			...
			for (var f = 0; f < this.customRenderTargets.length; f++) {
				var g = this.customRenderTargets[f];
				this._renderTargets.push(g)
			}
			var h = (new Date).getTime();
			if (this.renderTargetsEnabled) {
				for (var i = 0; i < this._renderTargets.length; i++) g = this._renderTargets.data[i], g._shouldRender() && (this._renderId++, g.render());
				this._renderId++
			}
			this._renderTargets.length > 0 && b.restoreDefaultFramebuffer(), this._renderTargetsDuration = (new Date).getTime() - h, this.postProcessManager._prepareFrame();
			...
			if (this.layers.length) {
				for (b.setDepthBuffer(!1), k = 0; k < this.layers.length; k++) l = this.layers[k], l.isBackground || l.render();
				b.setDepthBuffer(!0)
			}
			this._renderDuration += (new Date).getTime() - j, this.postProcessManager._finalizeFrame(a.isIntermediate), this.activeCamera._updateFromScene(), this._renderTargets.reset(), this.afterCameraRender && this.afterCameraRender(this.activeCamera)
			...
			this._animationRatio = .06 * e, this._animate(), this._physicsEngine && this._physicsEngine._runOneStep(e / 1e3), this._engine.clear(this.clearColor, this.autoClear || this.forceWireframe, !0);
			for (var f = 0; f < this.lights.length; f++) {
				var g = this.lights[f],
					h = g.getShadowGenerator();
				g.isEnabled() && h && -1 !== h.getShadowMap().getScene().textures.indexOf(h.getShadowMap()) && this._renderTargets.push(h.getShadowMap())
			}
			if (this.postProcessRenderPipelineManager.update(), this.activeCameras.length > 0)
				for (var i = this._renderId, j = 0; j < this.activeCameras.length; j++) this._renderId = i, this._processSubCameras(this.activeCameras[j]);
			else this._processSubCameras(this.activeCamera);
			this._checkIntersections(), this.afterRender && this.afterRender();
			for (var k = 0; k < this._toBeDisposed.length; k++) this._toBeDisposed.data[k].dispose(), this._toBeDisposed[k] = null;
			...
			this.postProcessManager.dispose(), this._physicsEngine && this.disablePhysicsEngine(), a = this._engine.scenes.indexOf(this), this._engine.scenes.splice(a, 1), this._engine.wipeCaches()
			...
			var g = e.viewport,
				h = g.toGlobal(f);
			return b = b / this._engine.getHardwareScalingLevel() - h.x, c = c / this._engine.getHardwareScalingLevel() - (this._engine.getRenderHeight() - h.y - h.height), a.Ray.CreateNew(b / window.devicePixelRatio, c / window.devicePixelRatio, h.width, h.height, d ? d : a.Matrix.Identity(), e.getViewMatrix(), e.getProjectionMatrix())
	...
	var b = function(b) {
		...
		return __extends(c, b), Object.defineProperty(c, "BILLBOARDMODE_NONE", {
			...
			if (b) {
				...
				} else c = b.x, d = b.y, e = b.z; if (this.parent) {
			...
			} else a.Matrix.TranslationToRef(this.position.x, this.position.y, this.position.z, this._localTranslation); if (this._pivotMatrix.multiplyToRef(this._localScaling, this._localPivotScaling), this._localPivotScaling.multiplyToRef(this._localRotation, this._localPivotScalingRotation), this.billboardMode !== c.BILLBOARDMODE_NONE) {
			...
			if (d) {
				...
				c.mass = c.mass || 0, c.friction = c.friction || .2, c.restitution = c.restitution || .9, this._physicImpostor = b, this._physicsMass = c.mass, this._physicsFriction = c.friction, this._physicRestitution = c.restitution, d._registerMesh(this, b, c)
			}
			...
			if (this.getScene().meshes.splice(e, 1), b)
		...
		return __extends(d, c), d.prototype.getTotalVertices = function() {
			...
			if (!c.mustReturn && this._geometry && this._geometry.getVertexBuffers() && this._geometry.getIndexBuffer()) {
				...
				if (g && g.isReady(this, f)) {
					g._preBind();
					var h = g.getEffect(),
						i = e.forceWireframe || g.wireframe;
					this._bind(a, h, i);
					var j = this.getWorldMatrix();
					if (g.bind(j, this), f) this._renderWithInstances(a, i, c, h, e);
					else if (c.renderSelf[a._id] && this._draw(a, !i), c.visibleInstances[a._id])
						for (var k = 0; k < c.visibleInstances[a._id].length; k++) {
							var l = c.visibleInstances[a._id][k];
							j = l.getWorldMatrix(), g.bindOnlyWorldMatrix(j), this._draw(a, !i)
						}
					for (g.unbind(), d = 0; d < this._onAfterRenderCallbacks.length; d++) this._onAfterRenderCallbacks[d]()
				}
			}
			...
			var b = this,
				c = this,
				d = this.getScene();
			this._geometry ? this._geometry.load(d) : c.delayLoadState === a.Engine.DELAYLOADSTATE_NOTLOADED && (c.delayLoadState = a.Engine.DELAYLOADSTATE_LOADING, d._addPendingData(c), a.Tools.LoadFile(this.delayLoadingFile, function(c) {
				b._delayLoadingFunction(JSON.parse(c), b), b.delayLoadState = a.Engine.DELAYLOADSTATE_LOADED, d._removePendingData(b)
			}, function() {}, d.database))
			...
			var a = [];
			return this.material && a.push(this.material), a
...
! function(a) {
	var b = function(b) {
		function c(d, e, f, g, h) {
			"undefined" == typeof h && (h = c.TRILINEAR_SAMPLINGMODE), b.call(this, e), this.uOffset = 0, this.vOffset = 0, this.uScale = 1, this.vScale = 1, this.uAng = 0, this.vAng = 0, this.wAng = 0, this.name = d, this.url = d, this._noMipmap = f, this._invertY = g, this._samplingMode = h, d && (this._texture = this._getFromCache(d, f), this._texture || (e.useDelayedTextureLoading ? this.delayLoadState = a.Engine.DELAYLOADSTATE_NOTLOADED : this._texture = e.getEngine().createTexture(d, f, g, e, this._samplingMode)))
		}
		return __extends(c, b), c.prototype.delayLoad = function() {
			this.delayLoadState == a.Engine.DELAYLOADSTATE_NOTLOADED && (this.delayLoadState = a.Engine.DELAYLOADSTATE_LOADED, this._texture = this._getFromCache(this.url, this._noMipmap), this._texture || (this._texture = this.getScene().getEngine().createTexture(this.url, this._noMipmap, this._invertY, this.getScene(), this._samplingMode)))
...
! function(a) {
	var b = function() {
		function b(a, b, c, d, e, f, g, h, i) {
			...
			var k, l;
			k = a.vertexElement ? document.getElementById(a.vertexElement) : a.vertex || a, l = a.fragmentElement ? document.getElementById(a.fragmentElement) : a.fragment || a, this._loadVertexShader(k, function(a) {
		...
		}, b.prototype._prepareEffect = function(b, c, d, e, f, g) {
			try {
				var h = this._engine;
				this._program = h.createShaderProgram(b, c, e), this._uniforms = h.getUniforms(this._program, this._uniformsNames), this._attributes = h.getAttributes(this._program, d);
				for (var i = 0; i < this._samplers.length; i++) {
					var j = this.getUniform(this._samplers[i]);
					null == j && (this._samplers.splice(i, 1), i--)
				}
				h.bindSamplers(this), this._isReady = !0, this.onCompiled && this.onCompiled(this)
			} catch (k) {
				if (!g && f) {
					for (i = 0; i < f.length; i++) e = e.replace(f[i], "");
					this._prepareEffect(b, c, d, e, f, !0)
				} else a.Tools.Error("Unable to compile effect: " + this.name), a.Tools.Error("Defines: " + e), a.Tools.Error("Optional defines: " + f), a.Tools.Error("Error: " + k.message), this._compilationError = k.message, this.onError && this.onError(this, this._compilationError)
			}
			...
			return __extends(d, c), d.prototype.needAlphaBlending = function() {
				...
				if (e.texturesEnabled) {
					...
					if (this.specularTexture && a.StandardMaterial.SpecularTextureEnabled) {
						...
						g.push("#define SPECULAR"), h.push(g[g.length - 1])
					}
				}
				if (e.getEngine().getCaps().standardDerivatives && this.bumpTexture && a.StandardMaterial.BumpTextureEnabled) {
					...
					g.push("#define BUMP"), h.push(g[g.length - 1])
				}
				e.clipPlane && g.push("#define CLIPPLANE"), f.getAlphaTesting() && g.push("#define ALPHATEST"), this._shouldUseAlphaFromDiffuseTexture() && g.push("#define ALPHAFROMDIFFUSE"), e.fogMode !== a.Scene.FOGMODE_NONE && (g.push("#define FOG"), h.push(g[g.length - 1]));
				var i = !1,
					j = 0;
				if (e.lightsEnabled)
					for (var k = 0; k < e.lights.length; k++) {
						...
						if (l.isEnabled()) {
							...
							if (!c || -1 === l.excludedMeshes.indexOf(c)) {
								g.push("#define LIGHT" + j), j > 0 && h.push(g[g.length - 1]);
								var o;
								o = l instanceof a.SpotLight ? "#define SPOTLIGHT" + j : l instanceof a.HemisphericLight ? "#define HEMILIGHT" + j : "#define POINTDIRLIGHT" + j, g.push(o), j > 0 && h.push(g[g.length - 1]);
								var p = l.getShadowGenerator();
								if (c && c.receiveShadows && p && (g.push("#define SHADOW" + j), j > 0 && h.push(g[g.length - 1]), i || (g.push("#define SHADOWS"), i = !0), p.useVarianceShadowMap && (g.push("#define SHADOWVSM" + j), j > 0 && h.push(g[g.length - 1])), p.usePoissonSampling && (g.push("#define SHADOWPCF" + j), j > 0 && h.push(g[g.length - 1]))), j++, j == b) break
							}
						}
					}
				var q = [a.VertexBuffer.PositionKind, a.VertexBuffer.NormalKind];
				c && (c.isVerticesDataPresent(a.VertexBuffer.UVKind) && (q.push(a.VertexBuffer.UVKind), g.push("#define UV1")), c.isVerticesDataPresent(a.VertexBuffer.UV2Kind) && (q.push(a.VertexBuffer.UV2Kind), g.push("#define UV2")), c.isVerticesDataPresent(a.VertexBuffer.ColorKind) && (q.push(a.VertexBuffer.ColorKind), g.push("#define VERTEXCOLOR")), c.skeleton && c.isVerticesDataPresent(a.VertexBuffer.MatricesIndicesKind) && c.isVerticesDataPresent(a.VertexBuffer.MatricesWeightsKind) && (q.push(a.VertexBuffer.MatricesIndicesKind), q.push(a.VertexBuffer.MatricesWeightsKind), g.push("#define BONES"), g.push("#define BonesPerMesh " + (c.skeleton.bones.length + 1)), g.push("#define BONES4"), h.push(g[g.length - 1])), d && (g.push("#define INSTANCES"), q.push("world0"), q.push("world1"), q.push("world2"), q.push("world3")));
				var r = g.join("\n");
				if (this._cachedDefines != r) {
					this._cachedDefines = r;
					var s = "default";
					e.getEngine().getCaps().standardDerivatives || (s = "legacydefault"), this._effect = e.getEngine().createEffect(s, q, ["world", "view", "viewProjection", "vEyePosition", "vLightsType", "vAmbientColor", "vDiffuseColor", "vSpecularColor", "vEmissiveColor", "vLightData0", "vLightDiffuse0", "vLightSpecular0", "vLightDirection0", "vLightGround0", "lightMatrix0", "vLightData1", "vLightDiffuse1", "vLightSpecular1", "vLightDirection1", "vLightGround1", "lightMatrix1", "vLightData2", "vLightDiffuse2", "vLightSpecular2", "vLightDirection2", "vLightGround2", "lightMatrix2", "vLightData3", "vLightDiffuse3", "vLightSpecular3", "vLightDirection3", "vLightGround3", "lightMatrix3", "vFogInfos", "vFogColor", "vDiffuseInfos", "vAmbientInfos", "vOpacityInfos", "vReflectionInfos", "vEmissiveInfos", "vSpecularInfos", "vBumpInfos", "mBones", "vClipPlane", "diffuseMatrix", "ambientMatrix", "opacityMatrix", "reflectionMatrix", "emissiveMatrix", "specularMatrix", "bumpMatrix", "darkness0", "darkness1", "darkness2", "darkness3"], ["diffuseSampler", "ambientSampler", "opacitySampler", "reflectionCubeSampler", "reflection2DSampler", "emissiveSampler", "specularSampler", "bumpSampler", "shadowSampler0", "shadowSampler1", "shadowSampler2", "shadowSampler3"], r, h, this.onCompiled, this.onError)
				}
			...
			if (this.idbFactory && (this.enableSceneOffline || this.enableTexturesOffline))
				if (this.db) b && b();
					...
					g.onerror = function() {
						...
						try {
							b.oldVersion > 0 && (e.db.deleteObjectStore("scenes"), e.db.deleteObjectStore("versions"), e.db.deleteObjectStore("textures")); {
	...
	var b = function(a, b) {
		...
		c = function() {
			...
			return c.prototype.getCapacity = function() {
				...
				var b = a.join("\n");
				if (this._cachedDefines != b) {
					this._cachedDefines = b;
					var c;
					c = this.fragmentElement ? {
						vertex: "particles",
						fragmentElement: this.fragmentElement
					} : "particles", this._effect = this._scene.getEngine().createEffect(c, ["position", "color", "options"], ["invView", "view", "projection", "vClipPlane", "textureMask"], ["diffuseSampler"], b)
				}
				return this._effect
...
! function(a) {
	var b = function() {
		...
		return b.prototype.isStopped = function() {
		...
		}, b.prototype.animate = function(a, c, d, e, f) {
			...
			}(c < this._keys[0].frame || c > this._keys[this._keys.length - 1].frame) && (c = this._keys[0].frame), (d < this._keys[0].frame || d > this._keys[this._keys.length - 1].frame) && (d = this._keys[this._keys.length - 1].frame);
			var i = d - c,
				j = a * this.framePerSecond * f / 1e3;
			if (j > i && !e) k = 0, g = !1, l = this._keys[this._keys.length - 1].value;
			else {
				var k = 0,
					l = 0;
				if (this.loopMode != b.ANIMATIONLOOPMODE_CYCLE) {
					var m = d.toString() + c.toString();
					if (!this._offsetsCache[m]) {
						var n = this._interpolate(c, 0, b.ANIMATIONLOOPMODE_CYCLE),
							o = this._interpolate(d, 0, b.ANIMATIONLOOPMODE_CYCLE);
						switch (this.dataType) {
							case b.ANIMATIONTYPE_FLOAT:
								this._offsetsCache[m] = o - n;
								break;
							case b.ANIMATIONTYPE_QUATERNION:
								this._offsetsCache[m] = o.subtract(n);
								break;
							case b.ANIMATIONTYPE_VECTOR3:
								this._offsetsCache[m] = o.subtract(n);
							case b.ANIMATIONTYPE_COLOR3:
						...
						this._highLimitsCache[m] = o
					}
					l = this._highLimitsCache[m], k = this._offsetsCache[m]
				}
			}
			var p = j / i >> 0,
				q = g ? c + j % i : d,
				r = this._interpolate(q, p, this.loopMode, k, l);
			if (this.targetPropertyPath.length > 1) {
				for (var s = this._target[this.targetPropertyPath[0]], t = 1; t < this.targetPropertyPath.length - 1; t++) s = s[this.targetPropertyPath[t]];
				s[this.targetPropertyPath[this.targetPropertyPath.length - 1]] = r
			} else this._target[this.targetPropertyPath[0]] = r;
			return this._target.markAsDirty && this._target.markAsDirty(this.targetProperty), g || (this._stopped = !0), g
...
! function(a) {
	var b = function() {
		...
		return b.prototype.isReusable = function() {
			...
			a = a || this._camera;
			var c = a.getScene(),
				d = (b ? b._width : this._engine.getRenderingCanvas().width) * this._renderRatio,
				e = (b ? b._height : this._engine.getRenderingCanvas().height) * this._renderRatio;
			if (this.width !== d || this.height !== e) {
				if (this._textures.length > 0) {
					for (var f = 0; f < this._textures.length; f++) this._engine._releaseTexture(this._textures.data[f]);
					this._textures.reset()
				}
				this.width = d, this.height = e, this._textures.push(this._engine.createRenderTargetTexture({
					width: this.width,
					height: this.height
				}, {
					generateMipMaps: !1,
					generateDepthBuffer: a._postProcesses.indexOf(this) === a._postProcessesTakenIndices[0],
			...
			this._engine.bindFramebuffer(this._textures.data[this._currentRenderTextureInd]), this.onActivate && this.onActivate(a), this._engine.clear(c.clearColor, c.autoClear || c.forceWireframe, !0), this._reusable && (this._currentRenderTextureInd = (this._currentRenderTextureInd + 1) % 2)
		...
		return a.prototype._prepareFrame = function(a) {
			...
			if (0 !== d.length && this._scene.postProcessesEnabled) {
				for (var e = this._scene.getEngine(), f = 0; f < d.length && (f < d.length - 1 ? c[d[f + 1]].activate(this._scene.activeCamera) : b ? e.bindFramebuffer(b) : e.restoreDefaultFramebuffer(), !a); f++) {
					var g = c[d[f]].apply();
					g && (e.bindBuffers(this._vertexBuffer, this._indexBuffer, this._vertexDeclaration, this._vertexStrideSize, g), e.draw(!0, 0, 6))
				}
	...
	var b = function() {
		function b(a, b, c) {
			this.name = a, this.lensFlares = new Array, this.borderLimit = 300, this._vertexDeclaration = [2], this._vertexStrideSize = 8, this._isEnabled = !0, this._scene = c, this._emitter = b, c.lensFlareSystems.push(this), this.meshesSelectionPredicate = function(a) {
				return a.material && a.isVisible && a.isEnabled() && a.checkCollisions && 0 != (a.layerMask & c.activeCamera.layerMask)
			};
			var d = [];
			...
			this._registeredMeshes = [], this.updateBodyPosition = function(a) {
				for (var b = 0; b < this._registeredMeshes.length; b++) {
					...
					if (c.mesh === a || c.mesh === a.parent) {
						var d = c.body.body;
						return d.setPosition(a.position.x, a.position.y, a.position.z), void d.setOrientation(a.rotation.x, a.rotation.y, a.rotation.z)
					}
					if (c.mesh.parent === a) {
						a.computeWorldMatrix(!0), c.mesh.computeWorldMatrix(!0);
						var e = c.mesh.getAbsolutePosition(),
							f = a.rotation;
						return d = c.body.body, d.setPosition(e.x, e.y, e.z), void d.setOrientation(f.x, f.y, f.z)
					}
				}
			}
		}
		return b.prototype._checkWithEpsilon = function(b) {
			...
			switch (this.unregisterMesh(b), b.computeWorldMatrix(!0), c) {
				...
				case a.PhysicsEngine.BoxImpostor:
					...
					var k = f.minimumWorld,
						l = f.maximumWorld,
						m = l.subtract(k),
						n = this._checkWithEpsilon(m.x),
						o = this._checkWithEpsilon(m.y),
						p = this._checkWithEpsilon(m.z);
					e = new OIMO.Body({
						type: "box",
						size: [n, o, p],
						pos: [b.position.x, b.position.y, b.position.z],
			...
			for (var d = 0; d < this._registeredMeshes.length; d++) {
				...
				if (e.mesh === a || e.mesh === a.parent) return void e.body.body.applyImpulse(c.scale(OIMO.INV_SCALE), b.scale(OIMO.INV_SCALE))
			}
			...
			for (var b, c = this._registeredMeshes.length; c--;) {
				...
				if (!d.sleeping)
					if (d.shapes.next) {
						var f = this._getLastShape(d);
						e.position.x = f.position.x * OIMO.WORLD_SCALE, e.position.y = f.position.y * OIMO.WORLD_SCALE, e.position.z = f.position.z * OIMO.WORLD_SCALE;
						var g = a.Matrix.FromArray(d.getMatrix());
						e.rotationQuaternion || (e.rotationQuaternion = new a.Quaternion(0, 0, 0, 1)), e.rotationQuaternion.fromRotationMatrix(g)
					} else b = d.getMatrix(), g = a.Matrix.FromArray(b), e.position.x = g.m[12], e.position.y = g.m[13], e.position.z = g.m[14], e.rotationQuaternion || (e.rotationQuaternion = new a.Quaternion(0, 0, 0, 1)), e.rotationQuaternion.fromRotationMatrix(g)
			}
		}, b
	}();
	a.OimoJSPlugin = b
...
! function(a) {
	var b = function() {
		...
		}, b.NoImpostor = 0, b.SphereImpostor = 1, b.BoxImpostor = 2, b.PlaneImpostor = 3, b.CompoundImpostor = 4, b.MeshImpostor = 4, b.CapsuleImpostor = 5, b.ConeImpostor = 6, b.CylinderImpostor = 7, b.ConvexHullImpostor = 8, b.Epsilon = .001, b
	}();
	a.PhysicsEngine = b
}(BABYLON || (BABYLON = {}));
var BABYLON;
! function(a) {
	var b = function(b) {
		...
		g = function(b) {
			var c = {};
			return c.name = b.name, c.ambient = b.ambientColor.asArray(), c.diffuse = b.diffuseColor.asArray(), c.specular = b.specularColor.asArray(), c.specularPower = b.specularPower, c.emissive = b.emissiveColor.asArray(), c.alpha = b.alpha, c.id = b.id, c.tags = a.Tags.GetTags(b), c.backFaceCulling = b.backFaceCulling, b.diffuseTexture && (c.diffuseTexture = h(b.diffuseTexture)), b.ambientTexture && (c.ambientTexture = h(b.ambientTexture)), b.opacityTexture && (c.opacityTexture = h(b.opacityTexture)), b.reflectionTexture && (c.reflectionTexture = h(b.reflectionTexture)), b.emissiveTexture && (c.emissiveTexture = h(b.emissiveTexture)), b.specularTexture && (c.specularTexture = h(b.specularTexture)), b.bumpTexture && (c.bumpTexture = h(b.bumpTexture)), c
		},
		h = function(b) {
			var c = {};
			...
			if (b instanceof a.MirrorTexture) {
				var e = b;
				c.renderTargetSize = e.getRenderSize(), c.renderList = [];
				for (var f = 0; f < e.renderList.length; f++) c.renderList.push(e.renderList[f].id);
				c.mirrorPlane = e.mirrorPlane.asArray()
			...
			var h = b;
			return c.name = b.name, c.hasAlpha = b.hasAlpha, c.level = b.level, c.coordinatesIndex = b.coordinatesIndex, c.coordinatesMode = b.coordinatesMode, c.uOffset = h.uOffset, c.vOffset = h.vOffset, c.uScale = h.uScale, c.vScale = h.vScale, c.uAng = h.uAng, c.vAng = h.vAng, c.wAng = h.wAng, c.wrapU = b.wrapU, c.wrapV = b.wrapV, d(b, c), c
		},
		i = function(a) {
			var b = {};
			...
			for (var c = 0; c < a.bones.length; c++) {
				...
				b.bones.push(f), d.animations && d.animations.length > 0 && (f.animation = e(d.animations[0]))
			}
			return b
		},
		j = function(a) {
		...
		n = function(b, c) {
			if (!m[b.id]) {
				if (b instanceof a.Geometry.Primitives.Box) c.boxes.push(r(b));
				else if (b instanceof a.Geometry.Primitives.Sphere) c.spheres.push(s(b));
				else if (b instanceof a.Geometry.Primitives.Cylinder) c.cylinders.push(t(b));
				else if (b instanceof a.Geometry.Primitives.Torus) c.toruses.push(u(b));
				else if (b instanceof a.Geometry.Primitives.Ground) c.grounds.push(v(b));
				else if (b instanceof a.Geometry.Primitives.Plane) c.planes.push(w(b));
				else if (b instanceof a.Geometry.Primitives.TorusKnot) c.torusKnots.push(x(b));
				else {
					if (b instanceof a.Geometry.Primitives._Primitive) throw new Error("Unknow primitive type");
					c.vertexData.push(p(b))
				}
				m[b.id] = !0
			}
		},
		...
		y = function(b, c) {
			...
			if (b.material ? e.materialId = b.material.id : b.material = null, b.skeleton && (e.skeletonId = b.skeleton.id), b.getPhysicsImpostor() !== a.PhysicsEngine.NoImpostor) switch (e.physicsMass = b.getPhysicsMass(), e.physicsFriction = b.getPhysicsFriction(), e.physicsRestitution = b.getPhysicsRestitution(), b.getPhysicsImpostor()) {
				case a.PhysicsEngine.BoxImpostor:
					e.physicsImpostor = 1;
					break;
				case a.PhysicsEngine.SphereImpostor:
			...
			return d(b, e), e.layerMask = b.layerMask, e
		},
		z = function() {
			function d() {}
			return d.Serialize = function(d) {
				var e = {};
				e.useDelayedTextureLoading = d.useDelayedTextureLoading, e.autoClear = d.autoClear, e.clearColor = d.clearColor.asArray(), e.ambientColor = d.ambientColor.asArray(), e.gravity = d.gravity.asArray(), d.fogMode && 0 !== d.fogMode && (e.fogMode = d.fogMode, e.fogColor = d.fogColor.asArray(), e.fogStart = d.fogStart, e.fogEnd = d.fogEnd, e.fogDensity = d.fogDensity), e.lights = [];
				for (var h = 0; h < d.lights.length; h++) {
					var o = d.lights[h];
					e.lights.push(b(o))
				}
				for (e.cameras = [], h = 0; h < d.cameras.length; h++) {
					var p = d.cameras[h];
					p instanceof a.FreeCamera && e.cameras.push(c(p))
				}
				for (d.activeCamera && (e.activeCameraID = d.activeCamera.id), e.materials = [], e.multiMaterials = [], h = 0; h < d.materials.length; h++) {
					var q = d.materials[h];
					q instanceof a.StandardMaterial ? e.materials.push(g(q)) : q instanceof a.MultiMaterial && e.multiMaterials.push(f(q))
				}
				for (e.skeletons = [], h = 0; h < d.skeletons.length; h++) e.skeletons.push(i(d.skeletons[h]));
				e.geometries = {}, e.geometries.boxes = [], e.geometries.spheres = [], e.geometries.cylinders = [], e.geometries.toruses = [], e.geometries.grounds = [], e.geometries.planes = [], e.geometries.torusKnots = [], e.geometries.vertexData = [], m = [];
				for (var r = d.getGeometries(), h = 0; h < r.length; h++) {
					var s = r[h];
					s.isReady() && n(s, e.geometries)
				}
				for (e.meshes = [], h = 0; h < d.meshes.length; h++) {
					var t = d.meshes[h];
					if (t instanceof a.Mesh) {
						var u = t;
						(u.delayLoadState === a.Engine.DELAYLOADSTATE_LOADED || u.delayLoadState === a.Engine.DELAYLOADSTATE_NONE) && e.meshes.push(y(u, e))
					}
				}
				for (e.particleSystems = [], h = 0; h < d.particleSystems.length; h++) e.particleSystems.push(j(d.particleSystems[h]));
				for (e.lensFlareSystems = [], h = 0; h < d.lensFlareSystems.length; h++) e.lensFlareSystems.push(k(d.lensFlareSystems[h]));
				for (e.shadowGenerators = [], h = 0; h < d.lights.length; h++) o = d.lights[h], o.getShadowGenerator() && e.shadowGenerators.push(l(o));
				return e
			}, d
		}();
	a.SceneSerializer = z
...
! function(a) {
	var b = function() {
					...
					var j = i._getPluginForFilename(d),
						l = function(a) {
							var g = [],
								i = [],
								k = [];
							return j.importMesh(b, e, a, c, g, i, k) ? void(f && (e.importedMeshesFiles.push(c + d), f(g, i, k))) : void(h && h(e))
						};
		...
		}, b.Load = function(b, c, d, e, f, g) {
			var h, i = this._getPluginForFilename(c.name || c),
				j = function(c) {
					var f = new a.Scene(d);
					return f.database = h, i.load(f, c, b) ? void(e && e(f)) : void(g && g(f))
				},
				k = function() {
					a.Tools.LoadFile(b + c, j, f, h)
				};
			return c.substr && "data:" === c.substr(0, 5) ? void j(c.substr(5)) : void(-1 === b.indexOf("file:") ? h = new a.Database(b + c, k) : a.Tools.ReadFile(c, j, f))
		}, b._ForceFullSceneLoadingForIncremental = !1, b._registeredPlugins = new Array, b
	}();
	a.SceneLoader = b
}(BABYLON || (BABYLON = {}));
var BABYLON;
	...
	! function() {
		var b = function(b, c, d) {
			...
			l = function(b, c) {
				...
				if (d.id = b.id, a.Tags.AddTagsTo(d, b.tags), void 0 !== b.intensity && (d.intensity = b.intensity), b.range && (d.range = b.range), d.diffuse = a.Color3.FromArray(b.diffuse), d.specular = a.Color3.FromArray(b.specular), b.excludedMeshesIds && (d._excludedMeshesIds = b.excludedMeshesIds), b.animations)
					for (var e = 0; e < b.animations.length; e++) {
						var f = b.animations[e];
						d.animations.push(k(f))
					}
				b.autoAnimate && c.beginAnimation(d, b.autoAnimateFrom, b.autoAnimateTo, b.autoAnimateLoop, 1)
			},
			m = function(b, c) {
				var d = new a.FreeCamera(b.name, a.Vector3.FromArray(b.position), c);
				...
				if (b.autoAnimate && c.beginAnimation(e, b.autoAnimateFrom, b.autoAnimateTo, b.autoAnimateLoop, 1), e.layerMask = b.layerMask && !isNaN(b.layerMask) ? Math.abs(parseInt(b.layerMask)) : 4294967295, b.instances)
					for (var h = 0; h < b.instances.length; h++) {
						...
						if (a.Tags.AddTagsTo(j, i.tags), j.position = a.Vector3.FromArray(i.position), i.rotationQuaternion ? j.rotationQuaternion = a.Quaternion.FromArray(i.rotationQuaternion) : i.rotation && (j.rotation = a.Vector3.FromArray(i.rotation)), j.scaling = a.Vector3.FromArray(i.scaling), j.checkCollisions = e.checkCollisions, b.animations)
							for (f = 0; f < b.animations.length; f++) g = b.animations[f], j.animations.push(k(g))
					}
				return e
			},
			x = function(a, b, c) {
			...
			z = function(b, c) {
				...
				if (e) {
					...
					f && f.applyToMesh(c)
				} else if (b.positions && b.normals && b.indices) {
					if (c.setVerticesData(a.VertexBuffer.PositionKind, b.positions, !1), c.setVerticesData(a.VertexBuffer.NormalKind, b.normals, !1), b.uvs && c.setVerticesData(a.VertexBuffer.UVKind, b.uvs, !1), b.uvs2 && c.setVerticesData(a.VertexBuffer.UV2Kind, b.uvs2, !1), b.colors && c.setVerticesData(a.VertexBuffer.ColorKind, b.colors, !1), b.matricesIndices)
						if (b.matricesIndices._isExpanded) delete b.matricesIndices._isExpanded, c.setVerticesData(a.VertexBuffer.MatricesIndicesKind, b.matricesIndices, !1);
							...
							for (var g = [], h = 0; h < b.matricesIndices.length; h++) {
								var i = b.matricesIndices[h];
								g.push(255 & i), g.push((65280 & i) >> 8), g.push((16711680 & i) >> 16), g.push(i >> 24)
							}
							c.setVerticesData(a.VertexBuffer.MatricesIndicesKind, g, !1)
						}
					b.matricesWeights && c.setVerticesData(a.VertexBuffer.MatricesWeightsKind, b.matricesWeights, !1), c.setIndices(b.indices)
				}
				if (b.subMeshes) {
					c.subMeshes = [];
					for (var j = 0; j < b.subMeshes.length; j++) {
						var k = b.subMeshes[j];
						new a.SubMesh(k.materialIndex, k.verticesStart, k.verticesCount, k.indexStart, k.indexCount, c)
					}
				}
		...
		a.SceneLoader.RegisterPlugin({
			extensions: ".babylon",
			importMesh: function(a, b, c, e, h, j, k) {
							...
							if (!r)
								for (var s = 0; s < l.multiMaterials.length; s++) {
									...
									if (t.id == q.materialId) {
										...
										n.push(t.id), g(t, b), r = !0;
										break
									}
								}
							r || (n.push(q.materialId), f(q.materialId, l, b, e))
						}
						if (q.skeletonId > -1 && b.skeletons) {
							var y = m.indexOf(q.skeletonId) > -1;
							if (!y)
				...
				if (l.particleSystems)
					for (p = 0; p < l.particleSystems.length; p++) {
						var C = l.particleSystems[p]; - 1 !== o.indexOf(C.emitterId) && j.push(i(C, b, e))
					}
				return !0
			},
			load: function(b, c, f) {
				var k = JSON.parse(c);
				b.useDelayedTextureLoading = k.useDelayedTextureLoading && !a.SceneLoader.ForceFullSceneLoadingForIncremental, b.autoClear = k.autoClear, b.clearColor = a.Color3.FromArray(k.clearColor), b.ambientColor = a.Color3.FromArray(k.ambientColor), b.gravity = a.Vector3.FromArray(k.gravity), k.fogMode && 0 !== k.fogMode && (b.fogMode = k.fogMode, b.fogColor = a.Color3.FromArray(k.fogColor), b.fogStart = k.fogStart, b.fogEnd = k.fogEnd, b.fogDensity = k.fogDensity);
				for (var n = 0; n < k.lights.length; n++) {
					var x = k.lights[n];
					l(x, b)
				}
				for (n = 0; n < k.cameras.length; n++) {
					var y = k.cameras[n];
					m(y, b)
				}
				if (k.activeCameraID && b.setActiveCameraByID(k.activeCameraID), k.materials)
					for (n = 0; n < k.materials.length; n++) {
						var z = k.materials[n];
						e(z, b, f)
					}
				if (k.multiMaterials)
					for (n = 0; n < k.multiMaterials.length; n++) {
						var A = k.multiMaterials[n];
						g(A, b)
					}
				if (k.skeletons)
					for (n = 0; n < k.skeletons.length; n++) {
						var B = k.skeletons[n];
						d(B, b)
					}
				var C = k.geometries;
				...
				for (n = 0; n < k.meshes.length; n++) {
					var T = k.meshes[n];
					w(T, b, f)
				}
				for (n = 0; n < b.cameras.length; n++) {
					var U = b.cameras[n];
					if (U._waitingParentId && (U.parent = b.getLastEntryByID(U._waitingParentId), delete U._waitingParentId), U instanceof a.FreeCamera) {
						var V = U;
						V._waitingLockedTargetId && (V.lockedTarget = b.getLastEntryByID(V._waitingLockedTargetId), delete V._waitingLockedTargetId)
					}
				}
				if (k.particleSystems)
					for (n = 0; n < k.particleSystems.length; n++) {
						var W = k.particleSystems[n];
						i(W, b, f)
					}
				if (k.lensFlareSystems)
					for (n = 0; n < k.lensFlareSystems.length; n++) {
						var X = k.lensFlareSystems[n];
						h(X, b, f)
					}
				if (k.shadowGenerators)
					for (n = 0; n < k.shadowGenerators.length; n++) {
						var Y = k.shadowGenerators[n];
						j(Y, b)
					}
				return !0
			}
...
! function(a) {
	var b = function(b) {
		...
		return __extends(c, b), c.prototype._checkInputs = function() {
			...
			this.cameraDirection = this.cameraDirection.add(c), this.cameraRotation = this.cameraRotation.add(this._rightjoystick.deltaPosition), this._leftjoystick.pressed || (this._leftjoystick.deltaPosition = this._leftjoystick.deltaPosition.scale(.9)), this._rightjoystick.pressed || (this._rightjoystick.deltaPosition = this._rightjoystick.deltaPosition.scale(.9))
		}, c.prototype.dispose = function() {
...
! function(a) {
	var b = function() {
		function b(a, b, c, d, e, f) {
			this._engine = a, this._name = b, this._postProcessType = c, this._ratio = d || 1, this._samplingMode = e || null, this._singleInstance = f || !0, this._cameras = [], this._postProcesses = [], this._indicesForCamera = [], this._renderPasses = [], this._renderEffectAsPasses = [], this.parameters = function() {}
		}
		return b._GetInstance = function(a, c, d, e) {
			for (var f, g, h = [], i = b._GetParametersNames(c), j = 0; j < i.length; j++) switch (i[j]) {
				case "name":
					h[j] = c.toString();
					break;
				case "ratio":
			...
			return f = function() {}, f.prototype = c.prototype, g = new f, c.apply(g, h), g
		}, b._GetParametersNames = function(a) {
			var b = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,
				c = a.toString().replace(b, ""),
				d = c.slice(c.indexOf("(") + 1, c.indexOf(")")).match(/([^\s,]+)/g);
			return null === d && (d = []), d
		}, b.prototype._update = function() {
		...
		}, b.prototype._attachCameras = function(c) {
			for (var d, e = a.Tools.MakeArray(c || this._cameras), f = 0; f < e.length; f++) {
				var g = e[f],
					h = g.name;
				d = this._singleInstance ? 0 : h, this._postProcesses[d] = this._postProcesses[d] || b._GetInstance(this._engine, this._postProcessType, this._ratio, this._samplingMode);
				var i = g.attachPostProcess(this._postProcesses[d]);
				null === this._indicesForCamera[h] && (this._indicesForCamera[h] = []), this._indicesForCamera[h].push(i), -1 === this._cameras.indexOf(g) && (this._cameras[h] = g);
				for (var j in this._renderPasses) this._renderPasses[j]._incRefCount()
			}
			...
			var a = this;
			for (var b in this._postProcesses) this._postProcesses[b].onApply = function(b) {
				a.parameters(b), a._linkTextures(b)
			}
...
! function(a) {
	var b = function() {
		...
		return b.prototype.addEffect = function(a) {
			...
			d && d.enable(a.Tools.MakeArray(c || this._cameras))
		}, b.prototype._disableEffect = function(b, c) {
			var d = this._renderEffects[b];
			d && d.disable(a.Tools.MakeArray(c || this._cameras))
			...
			var e = a.Tools.MakeArray(d || this._cameras),
				f = null;
			for (var g in this._renderEffects)
				if (f = this._renderEffects[g].getPass(c), null != f) break;
			if (null !== f) {
				for (var g in this._renderEffects) this._renderEffects[g]._disable(e);
				f._name = b.PASS_SAMPLER_NAME;
				for (var h = 0; h < e.length; h++) {
					var i = e[h],
						j = i.name;
					this._renderEffectsForIsolatedPass[j] = this._renderEffectsForIsolatedPass[j] || new a.PostProcessRenderEffect(this._engine, b.PASS_EFFECT_NAME, "BABYLON.DisplayPassPostProcess", 1, null, null), this._renderEffectsForIsolatedPass[j].emptyPasses(), this._renderEffectsForIsolatedPass[j].addPass(f), this._renderEffectsForIsolatedPass[j]._attachCameras(i)
				}
			}
		}, b.prototype._disableDisplayOnlyPass = function(c) {
			for (var d = a.Tools.MakeArray(c || this._cameras), e = 0; e < d.length; e++) {
				var f = d[e],
					g = f.name;
				this._renderEffectsForIsolatedPass[g] = this._renderEffectsForIsolatedPass[g] || new a.PostProcessRenderEffect(this._engine, b.PASS_EFFECT_NAME, "BABYLON.DisplayPassPostProcess", 1, null, null), this._renderEffectsForIsolatedPass[g]._disable(f)
			}
			for (var h in this._renderEffects) this._renderEffects[h]._enable(d)
		}, b.prototype._update = function() {
		...
		return b.prototype.reset = function() {
			...
			if (0 != this.renderList.length && this._colorShader.isReady()) {
				...
				for (var c = 0; c < this.renderList.length; c++) {
					...
					b.bindBuffers(this._vb.getBuffer(), this._ib, [3], 12, this._colorShader.getEffect()), this.showBackLines && (b.setDepthFunctionToGreaterOrEqual(), this._colorShader.setColor3("color", this.backColor), this._colorShader.bind(i), b.draw(!1, 0, 24)), b.setDepthFunctionToLess(), this._colorShader.setColor3("color", this.frontColor), this._colorShader.bind(i), b.draw(!1, 0, 24)
				}
		...
		var c = function() {
			...
			return b.GetTGAHeader = function(a) {
				...
				if (h && (l = d.subarray(e, e += f.colormap_length * (f.colormap_size >> 3))), g) {
					k = new Uint8Array(n);
					for (var o, p, q, r = 0, s = new Uint8Array(m); n > e;)
				...
				switch ((f.flags & b._ORIGIN_MASK) >> b._ORIGIN_SHIFT) {
					...
					case b._ORIGIN_UL:
						...
						break;
					case b._ORIGIN_BL:
						t = 0, v = 1, y = f.width, u = f.height - 1, w = -1, x = -1;
						break;
					case b._ORIGIN_UR:
						t = f.width - 1, v = -1, y = -1, u = 0, w = 1, x = f.height;
						break;
					case b._ORIGIN_BR:
						t = f.width - 1, v = -1, y = -1, u = f.height - 1, w = -1, x = -1
				}
	...
	var b = function() {
		function b() {
			this._registeredMeshes = [], this._physicsMaterials = [], this.updateBodyPosition = function(a) {
				for (var b = 0; b < this._registeredMeshes.length; b++) {
					...
					if (c.mesh === a || c.mesh === a.parent) {
						var d = c.body.body;
						return d.position.set(a.position.x, a.position.z, a.position.y), d.quaternion.x = a.rotationQuaternion.x, d.quaternion.z = a.rotationQuaternion.y, d.quaternion.y = a.rotationQuaternion.z, void(d.quaternion.w = -a.rotationQuaternion.w)
					}
				}
			}
		}
		return b.prototype.initialize = function(a) {
			...
			for (var c = 0; c < this._registeredMeshes.length; c++) {
				...
				d.isChild || (d.mesh.position.x = d.body.position.x, d.mesh.position.y = d.body.position.z, d.mesh.position.z = d.body.position.y, d.mesh.rotationQuaternion || (d.mesh.rotationQuaternion = new a.Quaternion(0, 0, 0, 1)), d.mesh.rotationQuaternion.x = d.body.quaternion.x, d.mesh.rotationQuaternion.y = d.body.quaternion.z, d.mesh.rotationQuaternion.z = d.body.quaternion.y, d.mesh.rotationQuaternion.w = -d.body.quaternion.w)
			}
		}, b.prototype.setGravity = function(a) {
			...
			var h = this._addMaterial(e, f),
				i = new CANNON.RigidBody(d, b, h);
			return g && (i.quaternion.x = g.x, i.quaternion.z = g.y, i.quaternion.y = g.z, i.quaternion.w = -g.w), i.position.set(c.position.x, c.position.z, c.position.y), this._world.add(i), this._registeredMeshes.push({
				mesh: c,
				body: i,
				material: h
			}), i
...
! function(a) {
	var b = function() {
		...
		return a.prototype._prepare = function() {}, a.prototype.getTriggerParameter = function() {
			...
			this._nextActiveAction.execute(a), this._nextActiveAction = this._nextActiveAction._child ? this._nextActiveAction._child : this
	...
	var b = function(b) {
		...
		return __extends(c, b), c.prototype._onNewGameConnected = function(a) {
			...
			if (this._gamepad) {
				...
				this.cameraDirection = this.cameraDirection.add(i), this.cameraRotation = this.cameraRotation.add(new a.Vector3(e.y, e.x, 0))
			}
		}, c.prototype.dispose = function() {
...
! function(a) {
	var b = function(b) {
		function c(c, d, e) {
			"undefined" == typeof e && (e = !1), b.call(this, c, d), this.color = new a.Color3(1, 1, 1), this._indices = new Array, this._colorShader = new a.ShaderMaterial("colorShader", d, "color", {
				attributes: ["position"],
				uniforms: ["worldViewProjection", "color"]
			})
		}
		return __extends(c, b), Object.defineProperty(c.prototype, "material", {
			...
			b.bindBuffers(this._geometry.getVertexBuffer(a.VertexBuffer.PositionKind).getBuffer(), c, [3], 12, this._colorShader.getEffect()), this._colorShader.setColor3("color", this.color)
